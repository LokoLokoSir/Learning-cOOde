...
public class TerminalManagerFase2 : MonoBehaviour
{
    ...
    CodigoFase2 interpreter2;

    private void Start() {
        interpreter2 = GetComponent<CodigoFase2>();
    }
    ...
    private void OnGUI() {
        if(terminalInput.isFocused && terminalInput.text != "" && Input.GetKeyDown(KeyCode.Return)) {
            ...
            int lines = AddInterpreterLines(interpreter2.Interpret(userInput));
