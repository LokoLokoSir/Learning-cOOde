...
public class TerminalMrFase3 : MonoBehaviour
{  public GameObject directoryLine;
    ...
    CodigoFase3 interpreter3;

    private void Start() {
        interpreter3 = GetComponent<CodigoFase3>();
    }
    ...
    private void OnGUI() {
        if(terminalInput.isFocused && terminalInput.text != "" && Input.GetKeyDown(KeyCode.Return)) {
            ...
            int lines = AddInterpreterLines(interpreter3.Interpret(userInput));
