...
public class TerminalMrFase4 : MonoBehaviour
{  public GameObject directoryLine;
    ...
    CodigoFase4 interpreter4;

    private void Start() {
        interpreter4 = GetComponent<CodigoFase4>();
    }
    ...
    private void OnGUI() {
        if(terminalInput.isFocused && terminalInput.text != "" && Input.GetKeyDown(KeyCode.Return)) {
            ...
            int lines = AddInterpreterLines(interpreter4.Interpret(userInput));
